...
//	@MMURLPattern(urlPattern = "/test/{}")
	@MMURLPattern(urlPattern = "/test/{}/test/{}/test/{}?param1={}&param2={}")
	public String getStuff(Long urlSegment1, String urlSegment2, String urlSegment3, String param1, Long param2) {
...
//	@MMURLPattern(urlPattern = "/{}/test/{}")
	@MMURLPattern(urlPattern = "/{}/test/{}/test2/{}?param1={}")
